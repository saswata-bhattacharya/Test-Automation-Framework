...
public class LoginTestsOld1 {

	public static void main(String[] args) {
		
		/*
		 * WebDriver wd = new ChromeDriver(); //Launch a browser window, browser session
		 * created
		 * 
		 ...
		 * browserUtility.enterText(emailTextBoxLocator, "lojaye4224@lxheir.com");
		 * 
